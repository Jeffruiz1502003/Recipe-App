...
function displayMeals(meals){
	...
	if(meals){
		...
		mealList.innerHTML = `<p>No meals found. 
		Try another ingredient.</p>`
	}
}

// Functions to create and display meal details on popup
...
function showMealDetailsPopup(meal) {
	mealDetailsContent.innerHTML = `
		...
		<div class="recipe-video">
			...
			traget="_blank">Vidoe Tutorial</a>
	`;
